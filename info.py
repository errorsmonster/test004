...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-c6072149828').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002044250842') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002141251057')).split()]
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'I_Am_MrAK') # owner username without @
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Tamil_Movies_Request_Group_AK') # Support Chat Link Without https:// or @
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '5f14184b5d330486d0ebcb32127fdca5b03c8b42')
# if verify second shortner is True then fill below url and api
VERIFY_SND_SHORTLINK_URL = environ.get('VERIFY_SND_SHORTLINK_URL', 'publicearn.com')
VERIFY_SND_SHORTLINK_API = environ.get('VERIFY_SND_SHORTLINK_API', '5f14184b5d330486d0ebcb32127fdca5b03c8b42')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/MrAK_LinkZz/5')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://mraktest-f20909bc6fc3.herokuapp.com/")
